...
AudioHelper AudioHelper::m_AudioHelper;

AudioHelper* AudioHelper::GetAudioHelper(int channels, int chunksize, int frequency)
{
    m_AudioHelper.Init(channels, chunksize, frequency);
