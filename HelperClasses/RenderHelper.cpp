...
RenderHelper RenderHelper::m_RenderHelper;

RenderHelper* RenderHelper::GetRenderHelper(const char* title, int width, int height, bool fullscreen)
{
    m_RenderHelper.Init(title, width, height, fullscreen);
...
{
    SDL_Texture* text_texture = LoadText(text, font_location, font_size, color);
